...
The 20 most recent merged PRs. This list is generated from GitHub and refreshes daily. Last updated: 2026-08-08.

<!-- recent-contributions:start -->

| Contribution | What changed | Creator |
| ------------ | ------------ | ------- |
| [TLC: adopt organization protocol 4.5 (audit only)](.github/workflows/tlc-4.5.yml) | TLC: adopt organization protocol 4.5 (audit only). | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [TLC: adopt organization protocol 4.5 (audit only)](.github/workflows/tlc-4.5.yml) | TLC: adopt organization protocol 4.5 (audit only). | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [Fix(server): clean deno check resolution and guard empty embedding-error message](server/index.ts) | Fix(server): clean deno check resolution and guard empty embedding-error message. | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [Fix(server): make capture_thought verifiable and embedding-failure safe](server/index.ts) | Fix(server): make capture_thought verifiable and embedding-failure safe. | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [Wire fingerprint dedup into kubernetes-deployment MCP capture](integrations/kubernetes-deployment/) | Wire fingerprint dedup into kubernetes-deployment MCP capture. | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [Add local Docker self-hosted deployment with Supabase migration](integrations/local-docker/) | Adds local Docker self-hosted deployment with Supabase migration. | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [Guard getEmbedding in kubernetes-deployment against malformed response](integrations/kubernetes-deployment/) | Guard getEmbedding in kubernetes-deployment against malformed response. | [@MichaelSaucier](https://github.com/MichaelSaucier) |
| [Guard getEmbedding against malformed OpenRouter response](server/index.ts) | Guard getEmbedding against malformed OpenRouter response. | [@MichaelSaucier](https://github.com/MichaelSaucier) |
